import './App.css';
import { useParams, useLocation, Routes, Route, Link, useNavigate } from "react-router-dom";
  ...
  return (
    <header className="navbar"> 
      ...
      <div className="nav-links">
        ...
        <Link className="bleeding-text" to="/orders">Orders</Link>  
        <Link className="bleeding-text" to="/cart">Cart</Link>
        <Link className="bleeding-text" to="/rules">Rules</Link>
      </div>
    ...
    <div className="App-header">
      ...
      <form onSubmit={handleEmailLogin} className="auth-form">
        ...
        <input 
          ...
          className="form-input"
        />
        <button type="submit" className="btn-horror">Log In</button>
      </form>

      <p>- OR -</p>

      <div className="oauth-container">
        <button onClick={() => handleOAuthLogin('google')} className="btn-horror oauth-btn">
          <FontAwesomeIcon icon={faGoogle} className="oauth-icon" /> Google
        </button>

        <button onClick={() => handleOAuthLogin('github')} className="btn-horror oauth-btn">
          <FontAwesomeIcon icon={faGithub} className="oauth-icon" /> GitHub
        </button>
      </div>
    ...
    <div className="App-header">
      ...
      <form onSubmit={handleEmailSignUp} className="auth-form">
        ...
        <input 
          ...
          className="form-input"
        />
        <button type="submit" className="btn-horror">Sign Up</button>
      </form>
  ...
  return (
    <div className="App-header"> 
      ...
      <div className="con">
        ...
        <img src={Banner} alt="The Woodsboro Murder books" className="banner-img" />
...
function BookDetail() {
  ...
  if (!book) {
    return (
      <div className="App-header">
        <HeaderNav userData={userData} />
        <div className="books-container not-found-container">
  ...
  return (
    <div className="App-header">
      ...
      <div className="section-container">
        ...
        <p className="subtext">Review your previous transactions from the Woodsboro archives.</p>

        {orders.length === 0 ? (
          <div className="empty-state">
            <p className="subtext">No past orders found.</p>
              ...
              <div key={order.id} className="order-card">
                <div className="order-card-header">
                  ...
                  <div className="order-total-block">
                    ...
                    <h3 className="order-total-amount">${order.total}</h3>
                  </div>
                </div>
        ...
        {cart.length === 0 ? (
          ...
          <div>
            <div className="cart-items-list">
              {cart.map((item) => (
                <div key={item.id} className="cart-item-card">
                  ...
                  <button className="btn-horror" onClick={() => removeFromCart(item.id)}>
                    Remove
                  </button>
                </div>
              ))}
            ...
            <div className="cart-summary">
              <h2>Total: ${total}</h2>
              <button
                className="btn-horror checkout-btn"
...
function Profile() {
  ...
  return (
    <div className="App-header">
      <HeaderNav userData={{ name: name || 'Ghostface', avatar: avatarUrl || Pro }} />

      <div className="profile-card">
        <h1 className="bleeding-text">Edit Profile</h1>
        ...
        <button onClick={handleLogout} className="btn-horror logout-btn">
          Log Out
        </button>
      </div>
